"""
Django settings for SlideCraft AI Backend
...
ROOT_URLCONF = 'slidecraft_backend.urls'
...
WSGI_APPLICATION = 'slidecraft_backend.wsgi.application'
...
if env('DATABASE_URL'):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('DB_NAME', default='slidecraft_ai'),
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://slidecraft-ai.vercel.app",
]
